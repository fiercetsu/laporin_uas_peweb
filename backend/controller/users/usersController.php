...
use App\Services\Users\GpsService;
...
class UsersController
{
    ...
    public function gpsUpdate(): void { (new GpsService())->update($_POST); }
    public function gpsCurrent(): void { (new GpsService())->current(); }
    public function gpsList(): void { (new GpsService())->list(); }
}
