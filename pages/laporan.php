...
<main class="container py-4 py-lg-5">
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
        <div>
            ...
            <h1 class="h3 mb-1 mt-2">Buat Laporan Kerusakan</h1>
            <p class="text-secondary mb-0">Isi detail laporan, lokasi, prioritas, dan foto bukti awal.</p>
        </div>
        ...
        <div class="card-body p-3 p-lg-4">
            ...
            <div class="row g-3">
                <div class="col-lg-7">
                    ...
                    <input class="form-control" id="judul" name="judul" value="<?= old('judul') ?>" maxlength="200" placeholder="Contoh: Lampu jalan mati di depan pos ronda" required>
                </div>
                <div class="col-lg-5">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4" placeholder="Jelaskan kerusakan dan kondisi sekitar lokasi." required><?= old('deskripsi') ?></textarea>
                </div>
                <div class="col-lg-8">
                    <label class="form-label" for="lokasi_detail">Lokasi Detail</label>
                    <input class="form-control" id="lokasi_detail" name="lokasi_detail" value="<?= old('lokasi_detail') ?>" maxlength="255" placeholder="Contoh: Jl. Melati RT 01 dekat mushola" required>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-8">
                    ...
                    <input class="form-control" id="maps_url" name="maps_url" value="<?= old('maps_url') ?>" placeholder="Opsional, tempel link maps jika ada">
                </div>
                <div class="col-lg-4">
                    <label class="form-label" for="fotos">Foto Bukti</label>
            ...
            <div class="border rounded-2 bg-light p-3 mt-4">
                <div class="d-flex flex-column flex-md-row justify-content-between gap-3">
                    <div>
                        ...
                        <div class="text-secondary text-small" id="gpsStatus">Belum mengambil lokasi.</div>
                    </div>
                    <button class="btn btn-outline-primary" id="gpsButton" type="button">
                        <i class="bi bi-geo-alt me-1"></i>Ambil Lokasi Saya
                    </button>
                </div>
            </div>

            <div class="d-flex justify-content-end gap-2 mt-4">
                <a class="btn btn-light" href="<?= e(urlFor('/dashboard')) ?>">Batal</a>
